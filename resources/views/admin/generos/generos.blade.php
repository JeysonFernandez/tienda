                    ...
                    <tbody>
                        ...
                        @foreach ($generos as $genero)
                            ...
                            <tr>
                                <td>{{$cont}}</td>
                            <td>{{$genero->nombre}}</td>
                            <td> <a href="/generos/{{ $genero->id }}/edit" onclick="nombre(this)"><i class="fas fa-fw fa-2x fa-pen-square" aria-hidden="true"></i></a>
                                <a data-toggle="modal" data-target="#deleteModal" href="#" onclick="nombre(this)" id="{{$genero->nombre}}-{{$genero->id}}"><i class="fas fa-fw fa-2x fa-trash-restore" aria-hidden="true"></i></a></td> 
                        </tr>
