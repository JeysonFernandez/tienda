                    ...
                    <form method="POST" action ="{{route('admin.pago.agregarPago')}}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="compra" id="compra" class="form-control" >
                                        <option value="{{$compra->id}}" selected> Cliente: {{$compra->usuario->nombre}} {{$compra->usuario->primer_apellido}}, Deuda Pendiente:  {{$compra->deuda_pendiente}}</option>
                                </select>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="monto"> Monto del Pago</label>
                                    <input type="number" value="0" id="monto" name="monto" min="0" max="{{$compra->deuda_pendiente}}" class="form-control"/>
                                </div>
                                <div class="form-group col-md-4">
