                            ...
                            <div class="form-group">
                                ...
                                <select name="compra" id="compra" class="form-control" >
                                    @foreach ($compras as $compra)
                                        <option value="{{$compra->id}}" @isset($id) @if($compra->id == $id) selected @endif @endisset> Cliente: {{$compra->usuario->nombre}} {{$compra->usuario->primer_apellido}}, Deuda Pendiente:  {{$compra->deuda_pendiente}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-row">
