...
<div class="container-fluid">
    <div class="card card-table shadow mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{route('admin.tipo.updateTipo',['id' => $tipo->id])}}" method="POST">
                @csrf
                <div class="row row-space">
                    <div class="col-12">
                        <div class="form-group">
                            <label class="label">Nombre</label>
                            <input class="form-control @error('nombre') is-invalid @enderror" type="text" id="nombre" name="nombre"   value="{{old('nombre') ?? $tipo->nombre ?? '' }}">
                        </div>
                    </div>
