    ...
    <div class="card card-table shadow mb-4">
        <div class="card-header py-3">
            <div class="d-flex bd-highlight mb-3">
                <div class="mr-auto p-2 bd-highlight"> <h3 class="m-0 font-weight-bold text-primary">Tabla de Tipos</h3></div>
                <div class="p-2 bd-highlight"><a href="{{route('admin.tipo.crearTipo')}}" class="btn btn-primary btn-lg text-right">Agregar</a></div>
                    ...
                    <tbody>
                        ...
                        @foreach ($tipos as $tipo)
                            ...
                            <tr>
                                <td>{{$cont}}</td>
                                <td>{{$tipo->nombre}}</td>
                                <td><a type="submit" class="btn btn-xs btn-success" data-toggle="tooltip" href="{{route('admin.tipo.editarTipo',['id' => $tipo->id])}}" title="Editar">
                                    <i class="fas fa-edit"></i>
                               </a>
                               <a type="submit" class="btn btn-xs btn-danger"data-toggle="modal" data-target="#deleteModal" href="#" onclick="nombre(this)" id="{{$tipo->nombre}}-{{$tipo->id}}"> <i class="fas fa-trash-alt"></i>
                               </a>
                           </td></tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer" >
                    ...
                    <form action="{{route('admin.tipo.confirmDelete')}}" method="POST" name="f1" id="f1" >
                        @csrf
                        @method('delete')
