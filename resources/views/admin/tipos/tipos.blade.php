                    ...
                    <tbody>
                        ...
                        @foreach ($tipos as $tipo)
                            ...
                            <tr>
                                <td>{{$cont}}</td>
                                <td>{{$tipo->nombre}}</td>
                                <td> <a href="/tipos/{{ $tipo->id }}/edit" onclick="nombre(this)"><i class="fas fa-fw fa-2x fa-pen-square" aria-hidden="true"></i></a>
                                <a data-toggle="modal" data-target="#deleteModal" href="#" onclick="nombre(this)" id="{{$tipo->nombre}}-{{$tipo->id}}"><i class="fas fa-fw fa-2x fa-trash-restore" aria-hidden="true"></i></a></td> 
                        </tr>
