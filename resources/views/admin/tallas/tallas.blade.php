                    ...
                    <tbody>
                        ...
                        @foreach ($tallas as $talla)
                            ...
                            <tr>
                                <td>{{$cont}}</td>
                                <td>{{$talla->nombre}}</td>
                                <td> <a href="/tallas/{{ $talla->id }}/edit" onclick="nombre(this)"><i class="fas fa-fw fa-2x fa-pen-square" aria-hidden="true"></i></a>
                                <a data-toggle="modal" data-target="#deleteModal" href="#" onclick="nombre(this)" id="{{$talla->nombre}}-{{$talla->id}}"><i class="fas fa-fw fa-2x fa-trash-restore" aria-hidden="true"></i></a></td> 
                        </tr>
