    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="d-flex bd-highlight mb-3">
                ...
                <div class="p-2 bd-highlight"><a href="{{route('colors.create')}}" class="btn btn-primary btn-lg text-right">Agregar</a></div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer" >
                    ...
                    <form action="{{route('colors.confirmDelete')}}" method="POST" name="f1" id="f1" >
                        @csrf
                        @method('delete')
