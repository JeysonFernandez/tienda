                ...
                <table class="table table-bordered text-center aling-center table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a type="submit" class="btn btn-xs btn-success" data-toggle="tooltip" href="{{route('admin.proveedor.editarProveedor',['id' => $proveedor->id])}}" title="Editar">
                                <i class="fas fa-edit"></i>
                           </a>
                           <a type="submit" class="btn btn-xs btn-danger"data-toggle="modal" data-target="#deleteModal" href="#" onclick="nombre(this)" id="{{$proveedor->nombre}}-{{$proveedor->id}}"> <i class="fas fa-trash-alt"></i>
                           </a>
                       </td> </tr>
